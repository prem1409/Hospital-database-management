...
?>
<center><font size = "8"><b>Patient Data</b></font></center><br>
<br>
<form action="patientfetch.php" method="post">
<center>
<label><font size = "5">Enter Patient ID:</font></label><br>
...
if($_SERVER["REQUEST_METHOD"] == "POST")
{
	...
	$sql = "SELECT * FROM patient WHERE id = '$myid1'";
	$result = $db->query($sql);
	echo "<br>";
